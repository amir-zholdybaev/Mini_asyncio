...
"""
    ...
    Более подробно:
    Вставляет елемент в очередь елементов
    ...
    Более подробно:
    Берет первый елемент из очереди елементов и вызывает функцию потребитель, отдав ей елемент
    Если в очереди елементов пусто, вставляет в очередь ожидающих геттеров себя же, вместе с переданным ему в аргументы
    потребителем
"""
